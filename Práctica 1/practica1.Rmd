...
Del mismo modo procedo con la siguiente función que encapsula el código general para poder entrenar un modelo con Naive Bayes o con Random Forest. Al finalizar mostrará información acerca de los parámetros de calidad del modelo obtenido como la matriz de confusión, la precisión o *accuracy*, entre otros. Para ello haremos uso de la función `confusionMatrix` [10] para obtener más información acerca del modelo a partir de la propia matriz de confusión.
