...
```{r}
# Dividimos el conjunto final en 70% entrenamiento y 30% test
train_pca<-train_pca %>% mutate(isFraud = as.factor(ifelse(isFraud == 1, 0, 1)))
...
############## INTENTAR CAMBIAR LOS 1->0 Y 2->1
...
predicciones<-predict(modelo_nb, datos$test)
```
...
[X] Andrie de Vries and Joris Meys, How to Take Samples from Data in R, https://www.dummies.com/programming/r/how-to-take-samples-from-data-in-r/
